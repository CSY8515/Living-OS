...
Verification: Vehicle 7/7, full regression 81/81, compilation PASS, SQLite integrity `ok`, foreign-key violations 0, page no-write smoke PASS, headless startup PASS. No owner data changed. Official commit, GitHub Release, Streamlit deployment, and production verification completed; production serves v1.5 Stable.
