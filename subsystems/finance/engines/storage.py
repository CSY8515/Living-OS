...
class FinanceStorageEngine(ComponentDatabaseAdapter):
    ...
    def __init__(self, database_path: Path, foundation: DatabaseSubsystem | None = None) -> None:
        super().__init__(
            database_path,
            component_id="SUB-FINANCE",
            display_name="Finance Subsystem",
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            connection.close()
        self.register_contract(schema_version=SCHEMA_VERSION, migration_id="finance-schema-v1")
