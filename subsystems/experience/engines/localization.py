...
UI_TEXT: dict[str, str] = {
    ...
    "Subsystem": "생활 영역", "Category": "분류", "Report Type": "리포트 유형",
    ...
    "Results": "결과", "Subsystems": "생활 영역", "Timeline events": "타임라인 이벤트",
    ...
    "Status history": "상태 이력", "Cross Subsystem Summary": "생활 영역 종합 요약",
...
WORD_TEXT = {
    ...
    "timeline": "타임라인", "global": "통합", "category": "분류", "subsystem": "생활 영역",
