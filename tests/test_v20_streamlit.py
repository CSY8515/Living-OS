...
class CanonicalStreamlitTests(unittest.TestCase):
    def test_every_canonical_v2_page_renders_without_errors(self) -> None:
            ...
            script.write_text(
                "\n".join(
                    [
                        ...
                        "from app.pages import render_dashboard, render_journal, render_decisions, render_reports, render_knowledge, render_analytics, render_review, render_ai_briefing, render_documents, render_module_manager, render_settings",
